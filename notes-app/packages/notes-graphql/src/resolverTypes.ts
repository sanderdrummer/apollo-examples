...
export type ResolversTypes = ResolversObject<{
  ...
  QueryNotesInput: ResolverTypeWrapper<QueryNotesInput>
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Note: Note
  Query: {}
  QueryNotesInput: QueryNotesInput
...
export type QueryNotesInputResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['QueryNotesInput'] = ResolversParentTypes['QueryNotesInput']
> = ResolversObject<{
  created?: Resolver<
...
export type Resolvers<ContextType = any> = ResolversObject<{
  ...
  QueryNotesInput?: QueryNotesInputResolvers<ContextType>
}>
